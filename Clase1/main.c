...
void ingresarPersonas(ST_PERSONAS[], int);
...
int main()
{
    ...
    */
    ...
    char consulta;
    int contador = 0;
    ingresarPersonas(personas, contador);
...
void imprimirPersonas(ST_PERSONAS personas[], int maximo){
    for (int i=0; i < maximo;i++){
        printf("Nombre: %s, Edad: %d", personas[i].nombre, personas[i].edad);
    }
}
...
void ingresarPersonas(ST_PERSONAS vec[], int indice){
